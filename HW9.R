...
result <- reshape(result, varying = c("test_size", "power"), v.names = "probability",timevar = "test", times = c("test_size", "power"), direction = "long",idvar = "sample_size",ids=n)
ggplot(result,aes(x=sample_size, group = test , colour = test))+
